...
const customers: Customer[] = [
    ...
    { id: 'C004', name: 'Diana Miller', phone: '555-0104', pendingDebt: 0, notes: 'Clienta VIP. Siempre ayudar con el equipaje.' },
...
const recentTrips: Trip[] = [
  {
    ...
    notes: 'Recoger en la entrada principal. El cliente espera con una maleta azul.',
    price: 15.75,
  },
  {
    id: 'T002',
  ...
  },
  {
    ...
    notes: 'La calle está en obras, es necesario entrar por la paralela.',
    price: 18.00,
  },
    {
    id: 'T004',
  ...
  },
  {
    ...
    notes: 'El cliente tiene mucho equipaje, se requiere ayuda.',
    price: 35.50,
  }
];
